        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {[
              ...
              "Next.js", "Express.js", "Jest", "Figma", "Redux", "GraphQL"
            ].map((tech, index) => (
              <span
                key={index}
                className="bg-white px-4 py-2 rounded-full text-gray-700 font-medium shadow-md hover:shadow-lg transition-shadow duration-200 border border-gray-200"
              >
                {tech}
              </span>
            ))}
